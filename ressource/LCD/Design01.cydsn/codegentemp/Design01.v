...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("0b7a93eb-9d45-40fb-b068-7f620f5e8b4d/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__BtnPin_net;
	wire [0:0] tmpFB_0__BtnPin_net;
	wire [0:0] tmpIO_0__BtnPin_net;
	wire [0:0] tmpINTERRUPT_0__BtnPin_net;
	electrical [0:0] tmpSIOVREF__BtnPin_net;
	...
	cy_psoc3_pins_v1_10
		...
		BtnPin
		 (.oe(tmpOE__BtnPin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BtnPin_net[0:0]}),
		  .io({tmpIO_0__BtnPin_net[0:0]}),
		  .siovref(tmpSIOVREF__BtnPin_net),
		  .interrupt({tmpINTERRUPT_0__BtnPin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BtnPin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CharLCD_v2_20_0 LCD_Char_1 ();

	wire [0:0] tmpOE__LedPin_net;
	wire [0:0] tmpFB_0__LedPin_net;
	wire [0:0] tmpIO_0__LedPin_net;
	wire [0:0] tmpINTERRUPT_0__LedPin_net;
	electrical [0:0] tmpSIOVREF__LedPin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		LedPin
		 (.oe(tmpOE__LedPin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LedPin_net[0:0]}),
		  .io({tmpIO_0__LedPin_net[0:0]}),
		  .siovref(tmpSIOVREF__LedPin_net),
		  .interrupt({tmpINTERRUPT_0__LedPin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LedPin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("205ded69-ba06-404c-b93a-7b47e8e71a88"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("94ece907-7ade-4c61-b4d3-9ad4c8834d30"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ad2b9bd6-291e-46ab-8956-e9dc8a776d07"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d1f159be-c3f9-4422-96cb-375fc18ef843"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8b5240a8-0a28-454c-80d7-c9576fa8edb4"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("08442a8a-95ef-41bf-86dd-5796ed75233a"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b3050efc-94f7-48f3-b9b6-cd714226c27a"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
