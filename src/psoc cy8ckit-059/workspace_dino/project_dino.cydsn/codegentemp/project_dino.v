// ======================================================================
// project_dino.v generated from TopDesign.cysch
// 05/12/2022 at 13:43
...
module ADC_DelSig_v3_30_1 (
	...
	cy_clock_v1_0
		#(.id("2e1533cd-fc1a-4db5-ae7b-fabd9d2df8cb/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("2e1533cd-fc1a-4db5-ae7b-fabd9d2df8cb/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1562500000"),
		  .is_direct(0),
...
module CharLCD_v2_20_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("13dba829-ebeb-4b05-b3a0-eb1843a4def8/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__photoresistor_analog_in_net;
	wire [0:0] tmpFB_0__photoresistor_analog_in_net;
	wire [0:0] tmpIO_0__photoresistor_analog_in_net;
	wire [0:0] tmpINTERRUPT_0__photoresistor_analog_in_net;
	electrical [0:0] tmpSIOVREF__photoresistor_analog_in_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .ovt_slew_control(2'b00),
		  .input_buffer_sel(2'b00))
		photoresistor_analog_in
		 (.oe(tmpOE__photoresistor_analog_in_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__photoresistor_analog_in_net[0:0]}),
		  .analog({Net_21}),
		  .io({tmpIO_0__photoresistor_analog_in_net[0:0]}),
		  .siovref(tmpSIOVREF__photoresistor_analog_in_net),
		  .interrupt({tmpINTERRUPT_0__photoresistor_analog_in_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__photoresistor_analog_in_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("b1a66d86-ecc7-44a2-b3f4-9e2acb8bdb61"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("77519379844.9612"),
		  .is_direct(0),
		  .is_digital(1))
		Clock_1
		 (.clock_out(Net_91));
