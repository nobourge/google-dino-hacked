...
#define BS_UDB_1_2_1_CONFIG_VAL ((const uint8 CYFAR *)0x48000478u)
...
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x48000504u)
...
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x4800051Cu)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG2_CFG0), 0x0743u);
